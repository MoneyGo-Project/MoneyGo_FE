    ...
    <Box sx={{ height: '100vh', overflow: 'hidden' }}>
      <Routes>
        ...
        <Route path="/" element={
          ...
          <Route path="simple-password/register" element={<SimplePasswordRegisterPage />} />
          <Route path="scheduled-transfer" element={<ScheduledTransferPage />} />
          <Route path="scheduled-transfers" element={<ScheduledTransferListPage />} />
